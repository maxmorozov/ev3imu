#ifndef __LSM330DLC_GYROSCOPE_H
#define __LSM330DLC_GYROSCOPE_H
...
namespace lsm330 {
    ...
    public:
        ...
        enum Scale
        {
            SCALE_250DPS,	// 00:  250 degrees per second
...
namespace traits {
	template <typename Transport>
    struct scale_count<lsm330::Gyroscope<Transport> > {
